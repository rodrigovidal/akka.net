...
akka.cluster.publish-stats-interval = 25 s")
    ...
    {
        public LeaderElectionWithFailureDetectorPuppetMultiJvmNode1() : base(true)
        {
        }
    }
    ...
    {
        public LeaderElectionWithFailureDetectorPuppetMultiJvmNode2() : base(true)
        {
        }
    }
    ...
    {
        public LeaderElectionWithFailureDetectorPuppetMultiJvmNode3() : base(true)
        {
        }
    }
    ...
    {
        public LeaderElectionWithFailureDetectorPuppetMultiJvmNode4() : base(true)
        {
        }
    }
    ...
    {
        public LeaderElectionWithFailureDetectorPuppetMultiJvmNode5() : base(true)
        {
        }
    }
